...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "web", "dev", "terminal", "comm", "inne" }, s, 
	{ layouts[9], layouts[9], layouts[2], layouts[2], layouts[2]
...
awful.util.spawn_with_shell(dev)
awful.util.spawn_with_shell(gg)
